        ...
        shapeGroups:[
          {
            ...
            //   },
               {
                path:'<svg style="left: 6px; top: 2px; width: 32px; height: 30px; display: block; position: relative; overflow: visible;"><g><g></g><g><g transform="scale(0.025,0.025)"><path d="M 49.322 0.002 v 313.185 l 41.176 -1.304 c 14.118 -114.315 106.899 -192.294 159.68 -205.234 c 52.814 -13.033 171.505 17.47 171.505 17.47 v 775.753 c 0 45.49 -80.12 65.598 -80.12 65.598 l -82.355 1.305 l -1.305 57.22 H 771.7 V 968.17 h -94.022 c -42.45 -3.847 -100.848 -68.297 -100.848 -68.297 V 124.122 s 98.272 -34.444 190.958 -17.564 c 92.686 16.912 171.256 210.509 171.256 210.509 h 41.175 V 0 H 49.315 l 0.007 0.001 Z" fill="#666666" stroke-miterlimit="10" pointer-events="all"></path></g></svg>',
                iconName:'',
                text:'text',
                command:'text'
              },
