 ...
 * @LastEditTime: 2020-12-14 16:36:33
...
class DesignEditor extends zrender.Group {
    constructor(domSelector, data){
        ...
        if(data.autoSize){
            this.data.width = width<800 ? 800 : width
            this.data.height = height<800 ? 800 : height
        }
    ...
    eventHandlers(){
        return {
            ...
            onUpdatePageStyle(newStyle){
                //是否自动大小
                if(newStyle.autoSize !== this.data.autoSize){
                    this.data.autoSize = newStyle.autoSize
                    if(this.data.autoSize){
                        let width = this.container.offsetWidth - 4 
                        let height = this.container.offsetHeight - 4
                        newStyle.width = width<800 ? 800 : width
                        newStyle.height = height<800 ? 800 : height
                    }                    
                    this.resize(newStyle.width, newStyle.height)
                }else if(!this.data.autoSize){
                    this.resize(newStyle.width, newStyle.height)
                }
            },
            onSelectWidget(e){
    ...
    removeEventListeners(){
        ...
        this.$cvd.off('updatePageStyle',this.handlers.onUpdatePageStyle)
    ...
    initEventListeners(){
        ...
        this.$cvd.on('updatePageStyle',this.handlers.onUpdatePageStyle, this)
