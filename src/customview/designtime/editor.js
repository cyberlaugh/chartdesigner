 ...
 * @LastEditTime: 2020-11-23 17:36:27
...
class DesignEditor extends zrender.Group {
     ...
     */
    addWidget(domWidget){
        console.log('addWidget',domWidget)
        this.$cvd.emit('addWidget', domWidget)
    }
    /**
     * @description: 添加图表组件
     * @param {*} chart
    ...
    addShape(data){
        ...
        try{
            ...
            switch(data.grp){
                case 'widgets':
                    element = new DeDomWidget({type:data.command,dataShape:data})
