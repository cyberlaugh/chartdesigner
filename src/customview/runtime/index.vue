 ...
 * @LastEditTime: 2020-11-21 12:40:50
 * @Tool: Auto Generated by koroFileHeader
-->
<script type="text/jsx">
import { cloneDeep, merge } from 'lodash'
import CvButton from './widgets/button'
...
import CvHtmlFragment from './widgets/htmlFragment'
            ...
            <div class="cv-wrapper" style={ this.pageStyle }>
                {
                    ...
                    this.widgets.map(c=>{
                         switch(c.type){
                            case 'button': return <cv-button props={ {cfg:c }} />
                            ...
                            case 'htmlFragment': return <cv-html-fragment  props={ {cfg:c} } />
